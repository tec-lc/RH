...
<head>
  ...
  <script src="js/class.Formulario.js" ></script>
  <script src="js/class.Principais.js" ></script>
  <script src="js/class.TrataDados.js" ></script>
    ...
    <div class="alinha alinha1">
      ...
      <div class="painelMenu" style="display:none;">
        <div class="autoRolagem">
          ...
          <a href="?pg=novo_projeto" target="_self">
            <div class="itemMenu">
              <!--<div class="iconItem"></div>-->
